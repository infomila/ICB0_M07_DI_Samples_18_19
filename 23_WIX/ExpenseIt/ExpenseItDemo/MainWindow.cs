...
namespace ExpenseItDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            EditBoxControlLibrary.EditBox edt = new EditBoxControlLibrary.EditBox();
        ...
        private void MainWindow_Initialized(object sender, EventArgs e)
        {
            ...
            costCenterTextBox.SelectedIndex = 0;
            emailTextBox.Text = "";
        ...
        private void commandBindingCreateExpenseReport_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            ValidationResult vr_e = evr.Validate(emailTextBox.Text, null);
            emailTextBoxErr.Content = vr_e.IsValid ? "" : vr_e.ErrorContent;
            //--------------------------------------------------------------------
            NumberValidationRule nvr = new NumberValidationRule();
            nvr.IsFixedLength = true;
            nvr.Length = 5;
            ValidationResult vr_n = nvr.Validate(employeeNumberTextBox.Text, null);
            employeeNumberTextBoxErr.Content = vr_n.IsValid ? "" : vr_n.ErrorContent;
            //--------------------------------------------------------------------------------

            lsbEmployeesErr.Content = lsbEmployees.SelectedIndex >= 0 ? "" : "Select an employee";
                ...
                )
            {
                ...
                pnlExpenseReport.Children.Add(dlg);
            }
